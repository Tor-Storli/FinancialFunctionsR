...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let header = "\
        ...
        \n\
        #' @usage NULL\n\
        #' @useDynLib FinancialFunctions, .registration = TRUE\n\
        NULL\n\
        \n\
    ";
    let footer = "# nolint end\n";
    let wrappers = financial_functions::get_financial_functions_metadata()
        .make_r_wrappers(true, "FinancialFunctions")
